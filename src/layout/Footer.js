...
& Public Liberties</Link></li>
                        ...
                        <div className="footerLinks">
                            ...
                            <ul>
                            <li><Link href={'/'} >About us</Link></li>
                                    <li k><Link href={'/'} >Code of ethics</Link></li>
                                    <li k><Link href={'/'} >Terms and conditions</Link></li>
                                    <li k><Link href={'/'} >Privacy Policy</Link></li>
                                    <li k><Link href={'/'} >Cookie Policy</Link></li>
                                    <li k><Link href={'/'} >Site policy</Link></li>
                                    <li k><Link href={'/'} >Community guidelines</Link></li>
